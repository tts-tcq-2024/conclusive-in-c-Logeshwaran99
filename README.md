...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? **yes,it helpped a lot to improve the standards**

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
**I will start to reduce the complexity in code and start to use the modularity in my regular works**
